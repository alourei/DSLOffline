...
Int_t main(Int_t argc,Char_t **argv){
  ...
  if(argc<4){
    ...
    Char_t outname[256];
    //sprintf(outname,"Test_output_%s",argv[3]);
    sprintf(outname,"Test_output.root");
   ...
   //Adding Addback spectra
    ...
    //Griffin
     ...
     Double_t Timestamp_Addback[MAX_MULT];
    ...
    theTree->Branch("Energy_Griffin",&Energy_Griffin,"E/D[mult_Griffin]");
    theTree->Branch("Channel_Griffin",&Channel_Griffin,"C/b[mult_Griffin]");
    theTree->Branch("Timestamp_Griffin",&Timestamp_Griffin,"t/l[mult_Griffin]");
    theTree->Branch("Mult_Griffin",&mult_Griffin,"mult/b");

    theTree->Branch("Energy_Addback",&Energy_Addback,"E/D[mult_Addback]");
    theTree->Branch("Detector_Addback",&Detector_Addback,"C/b[mult_Addback]");
    theTree->Branch("Timestamp_Addback",&Timestamp_Addback,"t/l[mult_Addback]");
    theTree->Branch("Mult_Addback",&mult_Addback,"mult/b");

    theTree->Branch("Energy_DeltaESil",&Energy_DeltaESil,"E/D[mult_DeltaESil]");
    theTree->Branch("Timestamp_DeltaESil",&Timestamp_DeltaESil,"t/l[mult_DeltaESil]");
    theTree->Branch("Mult_DeltaESil",&mult_DeltaESil,"mult/b");

    theTree->Branch("Energy_ESil",&Energy_ESil,"E/D[mult_ESil]");
    theTree->Branch("Timestamp_ESil",&Timestamp_ESil,"t/l[mult_ESil]");
    theTree->Branch("Mult_ESil",&mult_ESil,"mult/b");
